 ...
 * @version 1.3
 * @Download by http://www.lanrentuku.com
 * @date May 21, 2011
    ...
    a.fn.extend({
        beforeAfter: function (b) {
            ...
            return this.each(function () {
                ...
                a(k).prepend('<div id="dragwrapper' + c + '"><div id="drag' + c + '"><img width="12" height="56" alt="Move" src="./img/handle.png" title="Drag me left or right to see the before and after images" id="handle' + c + '" /></div></div>');
                a("#dragwrapper" + c).css({
                    opacity: 0.25,
                    position: "absolute",
                    padding: "0",
                ...
                // a(k).append('<img src="' + l.imagePath + '" width="7" height="15" id="lt-arrow' + c + '"><img src="' + l.imagePath + '" width="7" height="15" id="rt-arrow' + c + '">');
                if (l.showFullLinks) {
